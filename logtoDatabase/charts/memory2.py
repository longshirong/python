...
def trans_data_to_use(dataset: list):
    ...
    (
        Line(init_opts=opts.InitOpts(width="1600px", height="800px"))
            ...
            .add_yaxis(
            series_name="native_heap", y_axis=y_data_2,
            markpoint_opts=opts.MarkPointOpts(
                data=[
                    opts.MarkPointItem(type_="max", name="最大值"),
                    opts.MarkPointItem(type_="min", name="最小值"),
            ...
            .add_yaxis(
            series_name="code", y_axis=y_data_3,
            markpoint_opts=opts.MarkPointOpts(
                data=[
                    opts.MarkPointItem(type_="max", name="最大值"),
                    opts.MarkPointItem(type_="min", name="最小值"),
            ...
            .add_yaxis(
            series_name="stack", y_axis=y_data_4,
            markpoint_opts=opts.MarkPointOpts(
                data=[
                    opts.MarkPointItem(type_="max", name="最大值"),
                    opts.MarkPointItem(type_="min", name="最小值"),
            ...
            .add_yaxis(
            series_name="graphics", y_axis=y_data_5,
            markpoint_opts=opts.MarkPointOpts(
                data=[
                    opts.MarkPointItem(type_="max", name="最大值"),
                    opts.MarkPointItem(type_="min", name="最小值"),
            ...
            .add_yaxis(
            series_name="private_other", y_axis=y_data_6,
            markpoint_opts=opts.MarkPointOpts(
                data=[
                    opts.MarkPointItem(type_="max", name="最大值"),
                    opts.MarkPointItem(type_="min", name="最小值"),
            ...
            .add_yaxis(
            series_name="system", y_axis=y_data_7,
            markpoint_opts=opts.MarkPointOpts(
                data=[
                    opts.MarkPointItem(type_="max", name="最大值"),
                    opts.MarkPointItem(type_="min", name="最小值"),
            ...
            .add_yaxis(
            series_name="total", y_axis=y_data_8,
            markpoint_opts=opts.MarkPointOpts(
                data=[
                    opts.MarkPointItem(type_="max", name="最大值"),
                    opts.MarkPointItem(type_="min", name="最小值"),
